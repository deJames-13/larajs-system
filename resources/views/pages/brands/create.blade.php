<x-layouts.default>
	<x-card.page>
		<div class="flex items-center justify-between top">
			<h1 class="text-3xl font-extrabold">Add Brand</h1>
		...
		<form id="item-form" action="" method="POST"
			...
			<div class="px-2 py-4 right info-container">
				...
				<h3 class="text-2xl font-semibold border-b-2 border-opacity-25 border-primary">
					Brand Information
				</h3>
				<div class="flex flex-col space-y-4 ">
					...
					<div class="flex flex-col space-y-2">
						...
						<input type="text" name="company" id="company" class="input input-bordered"
					...
					<div class="flex flex-col space-y-2">
						...
						<input type="text" name="website" id="website" class="input input-bordered"
					...
					<div class="flex flex-col space-y-2">
						...
						<textarea name="description" id="description" class="textarea textarea-bordered" placeholder="Enter brand description"
						 rows="4"></textarea>
					</div>
				</div>
