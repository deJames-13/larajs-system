	...
	<div class="rounded-t-lg overflow-clip my-24">
		<div class="custom-circle-border bottom-pattern p-10 relative">
			...
			<div style="width:100%; display:flex; justify-content:space-between; align-items:center">
				...
				<div class="picture" style="height:40%;width:40%;">
					<img style=" width: 100%;height: 100%;object-fit: contain;overflow: hidden;border-radius: 20px;"
						src="{{ asset('images/newjeans.jpg') }}" alt="homepage">
				</div>
			</div>
