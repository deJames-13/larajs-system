            ...
            <div class="right info-container py-4 px-2">
                ...
                <div class="flex flex-col space-y-4 ">
                    ...
                    <div class="flex flex-col space-y-2">
                        ...
                        <textarea name="slug" id="slug" class="textarea textarea-bordered"
                            placeholder="Enter promo slug" rows="2"></textarea>
                    </div>
                    ...
                    <div class="flex flex-col space-y-2">
                        ...
                        <textarea name="description" id="description" class="textarea textarea-bordered"
                            placeholder="Enter promo description" rows="4"></textarea>
                    </div>
                </div>
