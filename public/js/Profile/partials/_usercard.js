      ...
      <div id="user-card" style="display: none" class="sm:hidden sm:w-0 md:w-full md:flex flex-col space-y-4 ">
        ...
        <div class="flex space-x-4 items-center">
          ...
          <div class="flex flex-col">
            <span id="profile-name" class="font-extrabold text-lg"> @${this.user.username || "_"} </span>
            <span id="profile-email" class="font-bold text-gray-400 text-md"> ${this.user.email || "email@example.com"} </span>

            <div id="view-more">
              <span id="profile-address" class="text-gray-700 text-xs"> ${(this.info.address || "") + " " + (this.info.zip_code || "")} </span>
              <br />
              <span id="profile-phone" class="text-gray-700 text-xs"> ${this.info.phone_number || ""} </span>
            </div>

            <a href="/profile" id="view-profile" class="hover:text-primary cursor-pointer font-bold text-gray-600 text-sm"> View More </a>
          </div>
        </div>
