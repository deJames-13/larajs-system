    ...
    const HTML = /* HTML */ `
      <div id="profile-edit" class="p-4">
        <div class="flex items-center justify-between">
          ...
          <div id="form-actions">
            <button data-button="save" class="btn btn-sm text-white btn-success hover:btn-primary">Save</button>
            <button data-button="cancel" class="btn btn-sm btn-secondary btn-outline hover:bg-error">Cancel</button>
          </div>
        </div>
