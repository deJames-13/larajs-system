...
const calculatePrice = (quantity, discount) => {
    // Replace the base price with actual brand-specific base price logic if needed
    ...
    ajaxRequest.post({
        ...
        onSuccess: (response) => {
            Swal.fire(
                {
                    title: 'Success',
                    text: 'This brand has been added to cart.',
                    icon: 'success',
